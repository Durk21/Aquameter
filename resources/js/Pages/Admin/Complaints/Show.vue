        ...
        <div class="max-w-2xl mx-auto px-4 md:px-6 py-6">
            ...
            <div class="bg-white rounded-lg border border-ocean-100 p-6 mb-6">
                <div class="flex items-start justify-between gap-3 mb-3">
                    <h2 class="font-semibold text-lg text-ocean-900">{{ complaint.subject }}</h2>
                    <span
            ...
            <div class="bg-white rounded-lg border border-ocean-100 p-6">
                <h3 class="font-semibold text-ocean-900 mb-4">Update Status</h3>
                <form @submit.prevent="submit">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea
                            ...
                            rows="4"
                            maxlength="2000"
                            class="block w-full border-ocean-300 focus:border-ocean-500 focus:ring-ocean-500 rounded-md shadow-sm"
